...
import com.llv.chapiion.netdemo.App;
import com.llv.chapiion.netdemo.net.client.cookie.PersistentCookieStore;
        ...
        if (mHttpClient == null) {
            ...
            try {
                ...
                mHttpClient = new OkHttpClient.Builder()
                        ...
                        .hostnameVerifier(hostnameVerifier)//验证主机名是否与服务器的身份验证方案匹配
                        // notice:  2 LoggerInterceptor拦截器添加 
